<template>
  <span class="color-picker-options">
    <span v-for="(color, index) in colors" :key="index" data-light="light" class="ql-picker-item ql-primary" :data-value="color" :style="{backgroundColor: color}" :title="names[index]" @click="handleColorClick(index)" @mouseover="handleColorHover(index)" />
    <input v-model="selectColor" type="text" class="color-input" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" maxlength="6">
  </span>
</template>
